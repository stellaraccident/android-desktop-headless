...
public final class Log {
    ...
    private static TerribleFailureHandler sWtfHandler = new TerribleFailureHandler() {
            public void onTerribleFailure(String tag, TerribleFailure what) {
            	throw new Error("Terrible Log Failure: " + tag + ": " + what);
    ...
    /** @hide */ public static int println_native(int bufID,
    	...
    	String priorityLabel="TRACE";
    	switch (priority) {
    	case DEBUG: priorityLabel="DEBUG"; break;
    	case ASSERT: priorityLabel="ASSERT"; break;
    	case ERROR: priorityLabel="ERROR"; break;
    	case WARN: priorityLabel="WARN"; break;
    	case INFO: priorityLabel="INFO"; break;
    	case VERBOSE: priorityLabel="VERBOSE"; break;
    	}
    	
    	String s=String.format("%s - %s (%s): %s", SystemClock.uptimeMillis(), priorityLabel, tag, msg);
